class TestEagerLoadingOnSQLite:
    ...
    def test_n2n_relations_eager(self):
        ...
        english = sqlite_loom.find_by_pk(
            Course,
            pk=engId,
            select=["id", "name"],
